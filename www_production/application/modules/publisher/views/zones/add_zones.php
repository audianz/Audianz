...
<legend><?php echo $this->lang->line('label_inventory_addzones_fieldset'); ?> </legend>
		...
		<p>
			...
			<input type="radio" onchange="showBannerForm()" checked="checked" name="zone_type" id="zone_type" value="1"/>&nbsp;&nbsp;<?php echo $this->lang->line('label_zone_type_1').'('.$mob_screens[0]['width'].'X'.$mob_screens[0]['height'].','.' '.$mob_screens[1]['width'].'X'.$mob_screens[1]['height'].','.' '.$mob_screens[2]['width'].'X'.$mob_screens[2]['height'].','.' '.$mob_screens[3]['width'].'X'.$mob_screens[3]['height'].')'; ?><br/>
