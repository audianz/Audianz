...
<p>
    ...
    <?php else: ?>
    	...
    	<div class="notification msgalert" style="width:400px;height:30px;">
    		<?php echo $this->lang->line('label_no_os'); ?> <a href="<?php echo site_url('admin/settings_device_os/add_device_os'); ?>"><?php echo $this->lang->line('label_click_add_os'); ?></a>
    	</div>
        <?php endif; ?>    
    <br/>
    </div>
    ...
    <?php if(count($devicemanuf)>0): ?>
    	...
    	<br/>
    	<div class="notification msgalert" style="width:400px;height:30px;">
    		<?php echo $this->lang->line('label_no_manuf'); ?> <a href="<?php echo site_url('admin/settings_device_manufacturers/add_device_manufacturer'); ?>"><?php echo $this->lang->line('label_click_add_manuf'); ?></a>
    	</div>
        <?php endif; ?>
    </div>
    <br/>
    ...
    <?php if(count($devicecap)): ?>
    	...
    	<br/>
    	<div class="notification msgalert" style="width:400px;height:30px;">
    		<?php echo $this->lang->line('label_no_cap'); ?> <a href="<?php echo site_url('admin/settings_device_capability/add_device_capability'); ?>"><?php echo $this->lang->line('label_click_add_cap'); ?></a>
    	</div>
        <?php endif; ?> 
    </div>
</p>
...
<p>
	...
	<br/>
	<div class="notification msgalert" style="width:400px;height:30px;">
		<?php echo $this->lang->line('label_no_ope'); ?> <a href="<?php echo site_url('admin/settings_geo_operators/add_geo_operators'); ?>"><?php echo $this->lang->line('label_click_add_ope'); ?></a>
	</div>
	<?php endif; ?> 
    </div>
</p>
