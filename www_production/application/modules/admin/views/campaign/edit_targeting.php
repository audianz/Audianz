...
<form name="form_mobile_targeting" id="form_mobile_targeting" enctype="multipart/form-data"
	action="<?php echo site_url('admin/inventory_campaigns/targeting_limitation_process'); ?>"
...
/* Click to action check */
	...
	return true;
		...
		<fieldset>
			...
			<div id="carrieroperator">
				<ul id="networkcarriers">
					...
					</span> <?php $region_list = $this->mod_campaign->get_region_operator($geo_country->country);	
			...
			<div id="intermediary"
				...
				<textarea rows="3" cols="50" name="txtarea" value="Description"><?php echo ($land[0]->description!='')?($land[0]->description):'';?></textarea>
				<p>
		...
		<input id="callchk" type="checkbox"	onchange="selectCheck()" name="callcheck" value="call" <?php echo in_array('call',$array)?'checked':''; ?> /> Click to
