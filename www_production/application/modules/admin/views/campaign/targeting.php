		...
		<fieldset>
			...
			<div id="deviceos">
				...
				<div class="notification msgalert"
					...
					<a
						href="<?php echo site_url('admin/settings_device_os/add_device_os'); ?>"><?php echo $this->lang->line('label_click_add_os'); ?>
					</a>
				</div>
				<?php endif; ?>
				<br />
			...
			<div id="devicemanuf">
				...
				<div class="notification msgalert"
					...
					<a
						href="<?php echo site_url('admin/settings_device_manufacturers/add_device_manufacturer'); ?>"><?php echo $this->lang->line('label_click_add_manuf'); ?>
					</a>
				</div>
				<?php endif; ?>
			</div>
			...
			<div id="devicecap">
				...
				<div class="notification msgalert"
					...
					<a
						href="<?php echo site_url('admin/settings_device_capability/add_device_capability'); ?>"><?php echo $this->lang->line('label_click_add_cap'); ?>
					</a>
				</div>
				<?php endif; ?>
			</div>
			...
			<div id="deviceloc">
				...
				<div class="notification msgalert"
					...
					<a
						href="<?php echo site_url('admin/settings_geo_locations/add_geo_location'); ?>"><?php echo $this->lang->line('label_click_add_loc'); ?>
					</a>
				</div>
				<?php endif; ?>
			</div>
			...
			<div id="carrieroperator">
				<ul id="networkcarriers">
					...
					?>
					<li><?php echo $geo_country->country; ?> <?php $region_list = $this->mod_campaign->get_region_operator($geo_country->country);	
			...
			<br> <input type="radio" id="allLoc" checked
				...
				<?php echo set_radio('loc','all',true);  ?> /> All locations </br> <input
				type="radio" id="specLoc" onchange="showTargetLocation()" name="loc"
			...
			<div id="intermediary"
				...
				<input id="interchk" type="checkbox" onchange="selectClick()"
					...
					<?php echo set_checkbox('inter', 'intermed'); ?> /> Show
