   ...
   <script>
		...
		<form id="edit_network" name="edit_network" action="<?php echo site_url('admin/camp_optimisation/network_edit_process'); ?>" method="post" >
		<h1 class="pageTitle"><?php echo "Edit Network Details" ?></h1>
		        ...
		        <fieldset>
		            ...
		            <p>
		                ...
		                <input type="text" name="type"  id="type" value="<?php echo $network[0]->Network_type; ?>" class="validate[required] sf" alt="<?php echo 'Please Enter Network type'; ?>"   />
		            ...
		            <p>
		                ...
		                <input type="text" name="network"  id="network" readonly  value="<?php echo $network[0]->Network; ?>" class="validate[required] sf" alt="<?php echo 'Please Enter Network'; ?>" style="background-color:#E0E0E0;"  readonly  />
			     ...
			     <p>
		                ...
		                <input type="text" name="cpm_rate"  id="cpm_rate" class="validate[required] sf"  value="<?php echo $network[0]->cpm_rate; ?>" alt="<?php echo "Please Enter Mix Percentage For Network"; ?>"  />
