		...
		<table cellpadding="0" cellspacing="0" class="childTable" id="userlist" width="100%">
            <thead>
                <tr>
                    ...
                    <th align="center" class="child0" width="10%"><?php echo $this->lang->line('lang_statistics_advertiser_call');?></th>
                    <th align="center" class="child0" width="10%"><?php echo $this->lang->line('lang_statistics_advertiser_web');?></th>
                    <th align="center" class="child0" width="10%"><?php echo $this->lang->line('lang_statistics_advertiser_map');?></th>
			   		...
			   		if(count($campaigns_list['campaigns'])){
						...
						foreach($campaigns_list['campaigns'] as $campID => $campaignname){
								...
								<tr style="font-weight:bold;">
									...
									<td><?php echo $camp_report[$campID]['CALL'] ?></td>
									<td><?php echo $camp_report[$campID]['WEB'] ?></td>
									<td><?php echo $camp_report[$campID]['MAP'] ?></td>
									...
									if(isset($campaigns_list['banners'][$campID]) AND count($campaigns_list['banners'][$campID])){
										...
										?>
											<tr>
												...
												<td><?php echo $banner_report[$campID][$bannerData['bannerid']]['CALL'] ?></td>
												<td><?php echo $banner_report[$campID][$bannerData['bannerid']]['WEB'] ?></td>
												<td><?php echo $banner_report[$campID][$bannerData['bannerid']]['MAP'] ?></td>
												<?php
