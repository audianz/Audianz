...
{?>
<a href="<?php echo site_url('admin/statistics_advertiser/export_view_date_wise');?>" title="<?php echo $this->lang->line('lang_export_excel_pub_title_as_date_wise');?>"><span class="export_excel_link"><?php echo $this->lang->line('lang_statistics_export');?></span></a>
<?php } ?>
</div>
<br/>		
<br/>
                ...
                <fieldset style="padding:5px;">
                	<div style="width:100%;height:50px;padding-top:10px;">
						...
						<div style="width:35%;height:50px;float:right;vertical-align:bottom;">
							...
							<?php endif; ?>
							<br/>
							<strong><?php echo $this->lang->line('lang_statistics_advertiser_from_start_date');?> :</strong> <?php echo date("m/d/Y",strtotime($searchObj['from_date']));  ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>
...
<table cellpadding="0" cellspacing="0" border="0" class="dyntable" id="adv_stat">
    <thead>
        <tr>
            ...
            <th class="head0"><?php echo $this->lang->line('lang_statistics_advertiser_spent');?> ($<?php echo number_format($stat_data['tot_val']['SPEND'],2,".",","); ?>)</th>
        </tr>
    </thead>
    <colgroup>
        <col class="con0" />
...
?>
    <tfoot>
        <tr>
            ...
            <th class="head0"><?php echo $this->lang->line('lang_statistics_advertiser_clicks');?> (<?php echo $stat_data['tot_val']['CLK']; ?>)</th>
            <th class="head1"><?php echo $this->lang->line('lang_statistics_advertiser_conversions');?> (<?php echo $stat_data['tot_val']['CON']; ?>)</th>
            <th class="head1"><?php echo $this->lang->line('lang_statistics_advertiser_call');?> (<?php echo $stat_data['tot_val']['CALL']; ?>)</th>
            <th class="head1"><?php echo $this->lang->line('lang_statistics_advertiser_web');?> (<?php echo $stat_data['tot_val']['WEB']; ?>)</th>
            <th class="head1"><?php echo $this->lang->line('lang_statistics_advertiser_map');?> (<?php echo $stat_data['tot_val']['MAP']; ?>)</th>
            <th class="head0"><?php echo $this->lang->line('lang_statistics_advertiser_ctr');?> (<?php echo number_format($stat_data['tot_val']['CTR'],2,".",","); ?>%)</th>
            <th class="head1"><?php echo $this->lang->line('lang_statistics_advertiser_spent');?> ($<?php echo number_format($stat_data['tot_val']['SPEND'],2,".",","); ?>)</th>
        </tr>
    </tfoot>
<?php }
?>
