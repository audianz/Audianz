...
<h1 class="pageTitle"><?php echo $this->lang->line('lang_statistics_global_history_on_country_wise');?></h1>
<?php
$data=$stat_data['stat_list'];
if(!empty($data))
{
?>
<a href="<?php echo site_url('admin/statistics_global/export_country_wise');?>" title="<?php echo $this->lang->line('lang_statistics_global_history_country_wise');?>"><span class="export_excel_link"><?php echo $this->lang->line('label_export_excel'); ?></span></a>
<?php } ?>
</div>
<br/>		
<br/>

		<form id="search_form" action="<?php echo site_url("admin/statistics_global/country_wise_statistics"); ?>" method="post">
...
<table cellpadding="0" cellspacing="0" border="0" class="dyntable" id="adv_stat">
    <thead>
        <tr>
         	<th class="head0"><?php echo $this->lang->line('lang_statistics_global_country');?></th>
