<title>File Manager | Mandy Lane - Premium Admin Template</title>
<link rel="stylesheet" media="" href="<?php echo base_url();?>assets/css/style.css" />
<link rel="stylesheet" href="<?php echo base_url();?>assets/css/plugins/elfinder.css" type="text/css"/>
...
<script type="text/javascript" src="<?php echo base_url();?>assets/js/plugins/elfinder.min.js"></script>
...
<div class="header">
    ...
    <!--logo-->
	<a href=""><img src="<?php echo base_url();?>images/logo2.png" alt="Logo" /></a>
  ...
  <table cellpadding="0" cellspacing="0" class="invoicetable" width="100%">
                	<thead>
                    	<tr>
                            ...
                            <td width="30%" align="right">Hours Billed</td>
                    ...
                    <tbody>
                        ...
                        <tr class="subtotal">
                            ...
                            <td align="right">$ 8 322.00</td>
                        </tr>
                        <tr>
                        	<td><em>*4.5% Sales Tax</em></td> 
                            <td align="right">&nbsp;</td>
                            <td align="right"><em>$ 122.00</em></td>
                        </tr>
                        <tr>
                        	<td colspan="3">&nbsp;</td> 
                        </tr>
                        <tr class="subtotal">
                        	<td>TOTAL</td> 
                            <td align="right">&nbsp;</td>
                            <td align="right" class="bordertop">$ 8 622.00</td>
                        </tr>
                    </tbody>
                </table>
