<div class="messagelist">
	...
	<?php foreach($rs as $row) : ?>
        <li <?php echo $class; ?>>
        	<a href="<?php echo site_url('admin/suggestions/suggestion_list'); ?>"><?php echo $row->suggestion_subject; ?></a>
	...
	<?php endif; ?>
    <div class="link"><a href="<?php echo site_url('admin/suggestions/suggestion_list'); ?>"><?php echo $this->lang->line('label_suggestions_tabview_list'); ?></a></div>
</div>
