...
<div class="loginlogo">
	...
	<?php }  elseif($title != '' ){ ?>
    <!-- logo -->
	<div style="height:54px" align="center"><font color="#FFFFFF" size="6"><?php echo $title;?></font></a></div>
...
<form id="loginform" action="<?php echo site_url('admin/login/forget_password_process'); ?>" method="post">
