...
<div style="margin-top:5px;" id="tabs" class="tabs2">
  <ul>
    <li style="padding: 0px !important; class="ui-state-default ui-corner-top ui-tabs-selected ui-state-active" class=""><a href="#tabs-1"><strong><?php echo $this->lang->line("label_inventory_zone_linked_by_banners");?></strong></a></li>
    <li style="padding: 0px !important;" class="ui-state-default ui-corner-top"><a href="#tabs-2"><strong><?php echo $this->lang->line("label_inventory_zone_linked_individual_banners");?></strong></a></li>
  </ul>
  <div id="tabs-1">
	...
	<?php endif; ?>
    <form name="show_linked_campaigns" id="show_linked_campaigns" method="post" action='<?php echo site_url("admin/inventory_zones/process/linkedbycampaigns");?>'>
      <div class="sTableOptions">
        <?php //echo $this->pagination->create_links(); ?>
        <a  class="button save1"><span><?php echo $this->lang->line('label_save_update'); ?></span></a>&nbsp;
        <a  class="button cancel"><span><?php echo $this->lang->line('label_cancel'); ?></span></a> </div>
      <!--sTableOptions-->
      ...
      <div class="sTableWrapper" width="100%">
        <table cellpadding="0" cellspacing="0" class="sTable" id="userlist" width="100%">
          ...
          <tr>
            ...
            <td><a class="view" href="<?php echo base_url().$img_path.$banner_data->filename; ?>"><?php echo $this->lang->line("label_show_banner");?></a><?php //echo anchor_popup(base_url().$img_path.$banner_data->filename,'Show Banner',$atts);?></td>
          </tr>
          <?php		
          ...
          <tr>
            <td><?php echo $banner_data->campaignname; ?></td>
            <td><?php echo $banner_data->description; ?></td>
            <td><a class="view" href="<?php echo site_url('admin/inventory_zones/show_text_banner/'.$banner_data->bannerid); ?>"><?php echo $this->lang->line("label_show_banner");?></a><?php //echo anchor_popup(site_url('inventory_zones/show_text_banner/'.$banner_data->bannerid),'Show Banner',$atts);?></td>
          </tr>
          <?php
							endif;						
						endforeach;
    ...
    <script type="text/javascript">
					...
					**/
					...
					jQuery('.cancel').click(function(){
						document.location.href='<?php echo site_url('admin/inventory_zones'); ?>';
					});		
			</script>
  </div>
  <div id="tabs-2"> 
	...
	<?php endif; ?>
    <form name="show_linked_banners" id="show_linked_banners" method="post" action='<?php echo site_url("admin/inventory_zones/process/linkedbybanners");?>'>
      <div class="sTableOptions">
        <?php //echo $this->pagination->create_links(); ?>
        <a class="button save2"><span><?php echo $this->lang->line('label_save_update'); ?></span></a>&nbsp;
        <a  class="button cancel"><span><?php echo $this->lang->line('label_cancel'); ?></span></a>
        </div>
      <!--sTableOptions-->
      <table cellpadding="0" cellspacing="0" class="sTableHead" width="100%">
        <colgroup>
