...
<h1 class="pageTitle"><?php echo $this->lang->line('lang_statistics_global_history_in_hour');?></h1>
<?php
$data=$stat_data['stat_list'];
if(!empty($data))
{
?>
<a href="<?php echo site_url('admin/statistics_global/export_global_hour_wise');?>" title="<?php echo $this->lang->line('lang_statistics_global_history_date_wise');?>"><span class="export_excel_link"><?php echo $this->lang->line('label_export_excel'); ?></span></a>
</div>
<br/><br/>
<?php }?>
                ...
                <fieldset style="padding:5px;">
                	<div style="width:100%;height:50px;padding-top:10px;">
						...
						<div style="width:49%;height:50px;float:right;vertical-align:bottom;">
							<strong>Date :</strong> <?php echo date("m/d/Y",strtotime($searchObj['sel_date']));  ?> 
							</div>
					</div>
				</fieldset>
            </div><!--form-->
...
<table cellpadding="0" cellspacing="0" border="0" class="dyntable" id="adv_stat">
    ...
    <tbody>
		...
		?>	
		<tr><td align="center" colspan="7"> <em><strong>Records Not Found.</strong></em> </td></tr>
		<?php endif; ?>
    </tbody>
    <tfoot>
      <tr>
