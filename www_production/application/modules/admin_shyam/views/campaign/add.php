...
?>
<form id="form_add_campaign" action="<?php echo site_url('admin/inventory_campaigns/add_campaign_process/'.$advertiser_id); ?>" method="post">
<h1 class="pageTitle"><?php echo $this->lang->line('label_inventory_add_campaign'); ?></h1>
        ...
        <fieldset>
            ...
            <p>
                ...
                <select name="advertiserlist"  id="advertiserlist" class="validate[required] " alt="<?php echo $this->lang->line("label_alert_advertiser"); ?>" <?php echo ($adv_id!=0)?"disabled":""; ?> onchange="fillAdv(this.value);">
                    <?php if(count($advertiser)>0){ ?>
			    <option value="" <?php echo set_select('advertiserlist', '', TRUE); ?>><?php echo $this->lang->line('label_choose').' '.$this->lang->line('label_inventory_advertiser'); ?></option>	
	  		    <?php	 	
                            for($i=0;$i<count($advertiser);$i++)
                            {
                                if($advertiser[$i]->clientid==$adv_id)
                                {
				$advertisername = $advertiser[$i]->clientid;  
                            ?>
                                <option selected="selected" value="<?php echo $advertiser[$i]->clientid; ?>" <?php echo set_select('advertiserlist', $advertiser[$i]->clientid); ?>><?php echo $advertiser[$i]->contact_name; ?></option>
                           <?php
                                }
                                else
                                { 									
                                ?>
                                <option value="<?php echo $advertiser[$i]->clientid; ?>" <?php echo set_select('advertiserlist', $advertiser[$i]->clientid); ?>><?php echo $advertiser[$i]->contact_name; ?></option>

                    <?php       }
                            }
                    } else { ?>
                    <option value=""><?php echo $this->lang->line('label_inventory_no_advertiser'); ?></option>
                    <?php } ?>
                </select>
                <input type="hidden" name="advertiser" id="advertiser" value="<?php echo $advertisername; ?>" />
            </p>
            ...
            <p>
                ...
                <input type="radio" onclick="startdate()"  name="start_date" id="start_date" value="0" <?php echo set_radio('start_date', '0',TRUE); ?> /> <?php echo $this->lang->line('label_camp_start_immediately'); ?> &nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <input id="campstart" name="campstart" type="text" class="validate[required]" alt="<?php echo $this->lang->line('label_alert_camp_start_date'); ?>"  value="<?php echo  form_text(set_value('campstart')); ?>"/>
            </p>
                ...
                <label for="email"><?php echo $this->lang->line('label_camp_end_date'); ?> <span style="color:red;" >*</span></label>
                 <input type="radio" checked="checked" onclick="enddate()" name="end_date" id="end_date" value="0" <?php echo set_radio('end_date', '0', TRUE); ?>/> <?php echo $this->lang->line('label_camp_dont_expire'); ?> &nbsp;&nbsp;&nbsp;&nbsp;
                         ...
                         <input id="campend" name="campend" type="text" class="validate[required]" alt="<?php echo $this->lang->line('label_alert_camp_end_date'); ?>" 
            ...
            <p>
				...
				value="<?php echo  form_text(set_value('weight')); ?>"/>
            </p>

            <p>
                <label for="budget"><?php echo $this->lang->line('label_inventory_daily_budget'); ?> <span style="color:red;" >*</span></label>
                <input type="text" name="budget"  id="budget" class="validate[required,max[99999999.99],funcCall[Decimalcheck]] sf" alt="<?php echo $this->lang->line('label_alert_budget'); ?>" 
				value="<?php echo  form_text(set_value('budget')); ?>"/>
            </p>

            <p id="rateimp">
                <label for="impr"><?php echo $this->lang->line('label_inventory_rate_impression'); ?> <span style="color:red;" >*</span></label>
                <input type="text" name="impression"  id="impression" class="validate[required,max[99999999.99],funcCall[Decimalcheck]] sf" alt="<?php echo $this->lang->line('label_alert_rate_impression'); ?>" 
            ...
            <p id="rateclick">
                ...
                <input type="text" name="clicks"  id="clicks" class="validate[required,max[99999999.99],funcCall[rateperclickcheck],funcCall[Decimalcheck]] sf" alt="<?php echo $this->lang->line('label_alert_rate_clicks'); ?>" 
		...
		{
		?>                
		<button type="button" style="margin-left:10px;" onclick="document.location.href='<?php echo site_url("admin/inventory_campaigns");?>'" ><?php echo $this->lang->line('label_cancel'); ?></button>
		<?php
		}
		else
		{
		?>
		<button type="button" style="margin-left:10px;" onclick="document.location.href='<?php echo site_url("admin/inventory_campaigns/listing_adv/all/".$adv_id);?>'" ><?php echo $this->lang->line('label_cancel'); ?></button>
		<?php
		}
		?>            
		</p>
