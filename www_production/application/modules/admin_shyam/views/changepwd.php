...
<form  action="<?php echo site_url('admin/site_settings/change_password_process'); ?>" method="post" name="change_password" id="change_password">
  <div class="form_default">
    ...
    <p>
      <label for="name"><?php echo $this->lang->line("settings_site_Old Password"); ?><span class="mandatory">*</span></label>
    ...
    <p>
      <label for="name"><?php echo $this->lang->line("settings_site_New Password"); ?><span class="mandatory">*</span></label>
    ...
    <p>
      <label for="email"><?php echo $this->lang->line("settings_site_Confirm Password"); ?><span class="mandatory">*</span></label>
