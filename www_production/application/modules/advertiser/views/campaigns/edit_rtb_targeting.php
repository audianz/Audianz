...
<?php if(count($target)>0):
    $target = $target[0]; ?>    
<?php endif; ?>
<form name="form_mobile_targeting" id="form_mobile_targeting" action="<?php echo site_url('advertiser/campaigns/rtb_targeting_limitation_process'); ?>" method="post" onsubmit="return check_filled_data();">
