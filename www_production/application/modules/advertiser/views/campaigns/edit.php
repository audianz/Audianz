...
<h1 class="pageTitle"><?php echo $this->lang->line('label_inventory_edit_campaign'); ?></h1>
		...
		<textarea name="promote_msg"  id="promote_msg" style="width:20%" ><?php echo $campaign->promote_msg; ?></textarea>
            </p>
            ...
            <p>
                ...
                <input type="text" name="total_impressions"  id="total_impressions" style="width:15%" class="validate[required]sf" alt="<?php echo "Please Enter Total Impressions value ."; ?>"
          ...
          <!--  <p>
                <label>Keyword 3<span style="color:red;" >*</span></label>
                <textarea name="key3"  id="key3" class="validate[required] sf" alt="<?php echo $this->lang->line('label_alert_budget'); ?>" ><?php echo $keywords[0]->keywords3 ?> </textarea>
            </p> -->
			...
			<?php /*/*$this->lang->line('label_inventory_rate_impression')*/?>
            <p id="rateimp">
