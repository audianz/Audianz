<script type="text/javascript"
	src="<?php echo base_url();?>assets/js/custom/dropdown.js"></script>
<script type="text/javascript">
jQuery(document).ready(function(){
		...
		var updateloc=jQuery('input[name=loc]:checked','#form_mobile_targeting').val();
		if(updateloc=='all')
		{
			hideTargetLocation()
		}
...
/*   Disable any two click to action if landing is not checked and one click to action is checked on load    */
...
<script
	...
	src="<?php echo base_url();?>/assets/js/custom/stickyFloat.js"></script>
<script type="text/javascript">
jQuery(document).ready(function(){
...
<form name="form_mobile_targeting" id="form_mobile_targeting" enctype="multipart/form-data"
	...
	<?php if($this->session->flashdata('rect_banner_error') !=''): ?>
	<div class="notification msgerror">
		<a class="close"></a>
		<p>
			<?php echo $this->session->flashdata('rect_banner_error'); ?>
		</p>
	</div>
	<?php endif; ?>
	<?php if($this->session->flashdata('file_chk') !=''): ?>
	<div class="notification msgerror">
		<a class="close"></a>
		<p>
			<?php echo $this->session->flashdata('file_chk'); ?>
		</p>
	</div>
	<?php endif; ?>
	...
	<div class="form_default" style="line-height: 25px; position: relative">
		<div id="menu" class="menu">
			...
			<div class="menu_title">
				<h4>
					<b><?php echo ucfirst($camp_summary->campaignname); ?> <?php echo $this->lang->line('label_full_details');?>
					</b>
				</h4>
			</div>
			<table cellspacing="0" cellpadding="0" width="100%" id="userlist"
				class="sTable3 scroll_table">
				<thead>
				</thead>
				<tbody>
					<tr>
						<td><?php echo $this->lang->line('label_campaign_name');?>
						</td>
						<td><?php echo ucfirst($camp_summary->campaignname);?>
						</td>
					</tr>
					<tr class="even">
						<td><?php echo $this->lang->line('label_date');?>
						</td>
						<td><?php echo date_format(date_create($camp_summary->activate_time),'jS F Y');?>
						</td>
					</tr>
					<tr>
						<td><?php echo $this->lang->line('label_budget');?></td>
						<td><i>$<?php echo $camp_summary->dailybudget;?>
						</i></td>
					</tr>
				</tbody>
			</table>
...
?>
			<div class="menu_title">
				<h4>
					<b><?php echo ucfirst($camp_summary->campaignname); ?> <?php echo $this->lang->line('label_ad_target_summary'); ?>
					</b>
				</h4>
			</div>
			<table cellspacing="0" cellpadding="0" width="100%" id="userlist"
				...
				<tbody>
					<tr>
						<td colspan="2"><span class="scroll_subtitile"><?php echo $this->lang->line('label_platform_devices'); ?>
						</span></td>
					</tr>
					<tr>
						<td><?php echo $this->lang->line("label_device_operating_system"); ?>
						</td>
						<?php //print_r($target); ?>
						<td><?php if($target->device_type ==='all'):
						echo $this->lang->line('label_all_device_os');
						elseif($target->device_type=='device_os'):
						?> <b><a href="" id="searchlink" rel="subcontent"><?php echo $this->lang->line('label_device_os_list');?><span
									class="popup_icon"></span> </a> </b>
							<div id="subcontent" class="popup_box">
								<h4>
									<?php echo $this->lang->line('label_device_os_title'); ?>
								</h4>
								<div class="list_data">
					...
					<tr class="even">
						<td><?php echo $this->lang->line('label_manufacturer_devices'); ?>
						</td>
						<?php //print_r($target); ?>
						<td><?php if($target->manufacturer_type ==='all'):
						echo $this->lang->line('label_all_manufacturers');
						elseif($target->manufacturer_type=='device_manufacturer'):
						?> <b><a href="#" id="searchlink1" rel="subcontent1"><?php echo $this->lang->line('label_device_manufacturers_list');?><span
									class="popup_icon"></span> </a> </b>
							<div id="subcontent1" class="popup_box">
								<h4>
									<?php echo $this->lang->line('label_device_manufacturer_title'); ?>
								</h4>
								<div class="list_data">
					...
					<tr>
						...
						<td><?php if($target->capability_type ==='all'):
						echo  $this->lang->line('label_all_device_capablities');
						elseif($target->capability_type=='device_capability'):
						?> <b><a href="#" id="searchlink2" rel="subcontent2"><?php echo $this->lang->line('label_device_capablities_list'); ?><span
									class="popup_icon"></span> </a> </b>
							<div id="subcontent2" class="popup_box">
								<h4>
									<?php echo $this->lang->line('label_device_capablities');?>
								</h4>
								<div class="list_data">
					...
					<tr>
						<td colspan="2"><span class="scroll_subtitile"><?php echo 'Mobile Geography / Locations';//$this->lang->line('label_mobile_geo_ope');?>
						</span></td>
					</tr>

					<tr>
						<td><?php echo $this->lang->line('label_geographic_locations');?>
						</td>
						<td><?php if($target->location_type ==='geographic_all'):
						echo $this->lang->line('label_all_locations');
						elseif($target->location_type=='geographic_locations'):
						?> <b><a href="#" id="searchlink3" rel="subcontent3"><?php echo $this->lang->line('label_geographic_loc_list');?><span
									class="popup_icon"></span> </a> </b>
							<div id="subcontent3" class="popup_box">
								<h4>
									<?php echo $this->lang->line('label_geographic_locations');?>
								</h4>
								<div class="list_data">
					...
					<tr>
						<td colspan="2"><span class="scroll_subtitile"><?php echo $this->lang->line('label_device_model');?>
								Device Model</span></td>
					</tr>
					...
					<tr>
						<td colspan="2"><span class="scroll_subtitile"><?php echo "Location targeting";?>
						</span></td>
					</tr>

					<tr>
						<td><?php echo "Targeting location";?></td>
						<td><?php 
						if($target->enable_loc =='all'):
						echo $this->lang->line('label_all');
						elseif($target->enable_loc=='spec'):
						echo "Specific Location";
					...
					<tr class="even">
						<td><?php echo "Click to Action";?></td>
						<td><?php if($target->landing_page !==''):
						echo $target->landing_page;
						else:
						echo "None";
						endif;
						?>
					...
					<!--  ***********************          Code added by shyam ends      ***************************************     -->




					<tr>
						<td colspan="2"><span class="scroll_subtitile"><?php echo $this->lang->line('label_demographics');?>
						</span></td>
					</tr>
					...
					<tr class="even">
						...
						<td><?php if($target->ages_type ==='all'):
...
/*	var intermed=document.getElementById('interchk').checked;
		...
		<fieldset>
			...
			<p>
				<input type="hidden" name="campaign" id="campaign"
					...
					id="osall" onclick="hideTargetOS();" value="all"
					<?php echo ($target->device_type=='all')?'checked':''; ?> />
				<?php echo $this->lang->line('label_target_allos'); ?>
				<br /> <input type="radio" name="os" id="osselect"
					onclick="showTargetOS();" value="device_os"
					<?php echo ($target->device_type=='device_os')?'checked':''; ?> />
					...
					<tr>
						<td align="center"><select name="source_os" id="source_os"
							multiple="multiple" size="<?php echo count($deviceos)+1; ?>">
								...
								for($i=0;$i<count($deviceos);$i++):
                                        if(!in_array($deviceos[$i]->os_value,$dos)): ?>
								<option value="<?php echo $deviceos[$i]->os_value; ?>">
									<?php echo $deviceos[$i]->os_platform; ?>
								</option>
								<?php endif;
								endfor;
								?>
						...
						<td align="center"><select name="destination_os[]"
							id="destination_os" class="validate[required] sf"
			...
			<input type="radio" name="manufacturer" id="manufall"
				onclick="hideTargetManu();" value="all"
				<?php echo ($target->manufacturer_type=='all')?'checked':''; ?> />
			...
			<br /> <input type="radio" name="manufacturer" id="manufselect"
				...
				<?php echo ($target->manufacturer_type=='device_manufacturer')?'checked':''; ?> />
					...
					<tr>
						<td align="center" valign="top"><select name="source_manu"
							...
							size="<?php echo count($devicemanuf)+1; ?>">
								...
								<option
									value="<?php echo $devicemanuf[$j]->manufacturer_name; ?>">
									<?php echo $devicemanuf[$j]->manufacturer_name; ?>
								</option>
								<?php endif;
                                    endfor; ?>
						</select>
			...
			<br /> <br /> <input type="radio" name="capabilty" id="capableall"
				onclick="hideTargetCap();" value="all"
				<?php echo ($target->capability_type=='all')?'checked':''; ?> />
			...
			<br /> <input type="radio" name="capabilty" id="capableselect"
				...
				<?php echo ($target->capability_type=='device_capability')?'checked':''; ?> />
					...
					<tr>
						<td align="center" valign="top"><select name="source_cap"
							...
							size="<?php echo count($devicecap)+1; ?>">
								...
								<option value="<?php echo $devicecap[$j]->capability_value; ?>">
									<?php echo $devicecap[$j]->capability_name; ?>
								</option>
								<?php endif;
                                    endfor; ?>
						</select>
			...
			<p>
				<input type="radio" name="geolocation" id="locatall"
					onclick="hideGeoLoc();" value="geographic_all"
					<?php echo ($target->location_type=='geographic_all')?'checked':''; ?> />
				...
				<br /> <input type="radio" name="geolocation" id="locatselect"
					...
					<?php echo ($target->location_type=='geographic_locations')?'checked':''; ?> />
					...
					<tr>
						<td align="center"><select name="source_loc" id="source_loc"
							...
							size="<?php echo (count($geolocation)>=20)?'20':count($geolocation); ?>">
								...
								<option value="<?php echo $geolocation[$k]->code; ?>">
									<?php echo $geolocation[$k]->name; ?>
								</option>
								<?php endif;
                                endfor; ?>
						</select>
			...
			<p>
				<input type="radio" name="nwcarrier" id="carrieroperator" checked
					...
					<?php echo ($target->carrier_type=='operator_all')?'checked':''; ?> />
				...
				<br /> <input type="radio" name="nwcarrier" id="carrieroperator"
					...
					<?php echo ($target->carrier_type=='mobileCarrierLimitation')?'checked':''; ?> />
			...
			<div id="carrieroperator">
				<ul id="networkcarriers">
					...
					?>
					<li
					<?php echo (in_array($geo_country->country,$country))?'style="color:#3E678E; font-weight:bold"':'style="color:#AAA;"'; ?>><span
						<?php echo (in_array($geo_country->country,$country))?'style="cursor:pointer;"':''; ?>><?php echo ucfirst($geo_country->country); ?>
					</span> <?php $region_list = $this->mod_campaigns->get_region_operator($geo_country->country);	
			if(!empty($region_list)):?>
						<ul>
							<?php foreach($region_list as $r): ?>
							<li><input type="checkbox" name="network_carriers[]"
							<?php echo (in_array($geo_country->country,$country) && in_array($r->id,$id))?'checked="checked"':''; ?>
								id="network_carriers"
			...
			<p>
				...
				<select name="mobdevice">
					<option <?php echo ($target->model_type==0)?'selected':''; ?>
						value="0">
						<?php echo $this->lang->line('label_no_limit'); ?>
					</option>
					<option <?php echo ($target->model_type=='==')?'selected':''; ?>
						value="==">
			...
			<br>
			<?php 
			$array=explode(',',$target->landing_page);

			?>
			<input type="radio" id="allLoc" onchange="hideTargetLocation()"
				name="loc" value="all"
				<?php echo ($target->enable_loc=='all')?'checked':'';  ?> /> All
			locations </br> <input type="radio" id="specLoc"
				onchange="showTargetLocation()" name="loc" value="spec"
				<?php echo ($target->enable_loc=='spec')?'checked':'';?> /> Target
			specific locations
			<div id="intermediary"
				style="margin-left: 0in; background: #FCEDF3; width: 4in;">

<input id="interchk" type="checkbox" onchange="selectClick()" name="inter"
 <?php echo ($target->intermediate==true)?'checked':''; ?> /> Show
				Intermidiary page </br> 
				
				
				<div id="content" style="background: #FCEDF3;">
				<textarea id="desc" rows="3" cols="50" name="txtarea" value="Description"><?php echo ($land[0]->description!='')?($land[0]->description):'';?></textarea>
				<p>
				<label for="name">Upload-Main Rectangle-XL
				 <!-- <span style="color:red;" >*</span>  -->
				 </label>
			 <input class="sf" type="file" name="rect_banner_xl" alt="Please select Rect banner" value="<?php echo set_value('rect_banner_xl'); ?>"/>
	
			<?php 
		
		    $url=$this->config->item('base_url').$this->config->item('rect_banner_path').$land[0]->rect_banner_xl;  
			if($land[0]->rect_banner_xl!=''):?>
				&nbsp;&nbsp;&nbsp;	
				
				<a class="view" href=<?php echo $url;?>>Preview</a>
				
	    <?php endif; ?>
				</p>
				<p>
				<label for="name">Upload-Main Rectangle-L
				 
				 </label>
			 <input class="sf" type="file" name="rect_banner_l" alt="Please select Rect banner" value="<?php echo set_value('rect_banner_l'); ?>"/>
	
			<?php 
			
		    $url=$this->config->item('base_url').$this->config->item('rect_banner_path').$land[0]->rect_banner_l;  
		
		    if($land[0]->rect_banner_l!=''):?>
				&nbsp;&nbsp;&nbsp;	
	    ...
	    <?php endif; ?>
				...
				<p>
				<label for="name">Upload-Main Rectangle-M
				
				 </label>
			 <input class="sf" type="file" name="rect_banner_m" alt="Please select Rect banner" value="<?php echo set_value('rect_banner_m'); ?>"/>
	
			<?php 
			
		    $url=$this->config->item('base_url').$this->config->item('rect_banner_path').$land[0]->rect_banner_m;  
			if($land[0]->rect_banner_m!=''):?>
				&nbsp;&nbsp;&nbsp;	
	    ...
	    <?php endif; ?>
				...
				<p>
				<label for="name">Upload-Main Rectangle-S
				
				 </label>
			 <input class="sf" type="file" name="rect_banner_s" alt="Please select Rect banner" value="<?php echo set_value('rect_banner_s'); ?>"/>
	
			<?php 
			
		    $url=$this->config->item('base_url').$this->config->item('rect_banner_path').$land[0]->rect_banner_s;  
			if($land[0]->rect_banner_s!=''):?>
				&nbsp;&nbsp;&nbsp;	
	    ...
	    <?php endif; ?>
				...
				<input id="callchk" type="checkbox"
					onchange="selectCheck()" name="callcheck" value="call"
					<?php echo in_array('call',$array)?'checked':''; ?> /> Click to
				Call &nbsp;&nbsp; <input id="mapchk" type="checkbox"
					onchange="selectCheck()" name="mapcheck" value="map"
					<?php echo in_array('map',$array)?'checked':''; ?> /> Click to Map
				&nbsp;&nbsp; <input id="webchk" type="checkbox"
					onchange="selectCheck()" name="webcheck" value="web"
					<?php echo in_array('web',$array)?'checked':''; ?> /> Click to Web
			</div>
			<br> <br>
			<h2>
			...
			<div style="width: 400px; height: 250px; line-height: 25px;">
				...
				<div style="float: right;">
					...
					<input type="radio" name="agegroup" id="allage"
						onclick="hideAgeGroup();" value="all"
						<?php echo ($target->ages_type=='all')?'checked':''; ?> />
					...
					<br /> <input type="radio" name="agegroup" id="specage"
						...
						<?php echo ($target->ages_type=='specific')?'checked':''; ?> />
                ...
                if(in_array($totage,$selage)): ?>
						<input type="checkbox" checked name="selage[]"
							id="selage<?php echo $totage; ?>" value="<?php echo $totage; ?>" />
						<?php echo $totage; ?>
						&nbsp;&nbsp;<br />
						<?php else: ?>
...
<div id="tooltip" style="display: none;">
	<h3 style="display: none;">
		<?php echo $this->lang->line('label_target_tooltip');?>
	</h3>
</div>
<script>
			/*
