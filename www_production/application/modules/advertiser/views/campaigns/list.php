...
<h1 class="pageTitle">
	<?php echo $this->lang->line('label_advertiser_manage_campaigns');?>
</h1>
<br />
<div id="buttons" style="width: 99%; height: 40px;">
	<div style="width: 45%; float: left;">
		<a href="javascript:void(0);" onclick="runcamps();" class="iconlink"><img
			src="<?php echo base_url(); ?>assets/images/icons/play.jpeg"
			class="mgright5" alt="" /> <span><?php echo $this->lang->line('label_run_campaign');?>
		</span> </a> <a href="javascript:void(0);" onclick="pausecamps();"
			class="iconlink"><img
			src="<?php echo base_url(); ?>assets/images/icons/pause.png"
			class="mgright5" alt="" /> <span><?php echo $this->lang->line('label_pause_campaign');?>
		</span> </a> <a href="javascript:void(0);" onclick="delcamps();"
			class="iconlink"><img
	...
	<div style="width: 44%; float: right; text-align: right;">
		<a href="<?php echo site_url('advertiser/campaigns/add'); ?>"
			class="iconlink"><img
			src="<?php echo base_url(); ?>assets/images/icons/small/white/plus.png"
			class="mgright5" alt="" /> <span><?php echo $this->lang->line('label_advertiser_campaign_add_campaign');?>
		</span> </a>
	</div>
</div>
...
<table cellpadding="0" cellspacing="0" border="0" class="dyntable" id="camptab">
	...
	<tbody>
		...
		<tr class="gradeX">
			...
			<td class="con0"><?php echo $camp->campaignname; ?> <br /> <a
				href="<?php echo site_url('advertiser/campaigns/edit/'.$camp->campaignid); ?>"><?php echo $this->lang->line('label_advertiser_campaign_edit');?>
			</a> -
			 <a	href="<?php echo site_url('advertiser/campaigns/duplicate/'.$camp->campaignid); ?>"><?php echo $this->lang->line('label_advertiser_campaign_duplicate');?>
			</a>
			</td>

			<td class="con1"><?php echo date('M d,Y', strtotime($camp->activate_time)); ?>
			</td>
			<td class="con0"><?php echo ucfirst($this->mod_campaigns->get_campaign_status($camp->status)); ?>
			</td>

			<?php $no_of_banners= $this->mod_campaigns->get_total_liked_banners($camp->campaignid);?>
			<td class="center con1"><a
				href="<?php echo site_url('advertiser/banners/listing/'.$camp->campaignid); ?>"><?php echo $this->lang->line('label_advertiser_campaign_banner');?>
			</a> [<?php echo !empty($no_of_banners)?"$no_of_banners":"0";?>]&nbsp;&nbsp;/
				<?php if($camp->rtb==1): ?> <a
				href="<?php echo site_url('advertiser/campaigns/rtb_targeting/'.$camp->campaignid.'/'.$camp->rtb); ?>">RTb&nbsp;<?php echo $this->lang->line('label_advertiser_campaign_targeting');?>
			</a> <?php else: ?> <a
				href="<?php echo site_url('advertiser/campaigns/targeting/'.$camp->campaignid); ?>"><?php echo $this->lang->line('label_advertiser_campaign_targeting');?>
			</a> <?php endif;?> <?php if($camp->revenue_type=='3'): ?>/ <a
				href="<?php echo site_url('advertiser/campaigns/trackers/'.$camp->campaignid); ?>"><?php echo $this->lang->line('label_trackers'); ?>
			</a> <?php endif; ?>
			</td>
			<td class="center con0"><?php echo $this->mod_campaigns->get_revenue_type($camp->revenue_type); ?>
			</td>
			...
			<td class="center con1"><?php echo ($impressions!='')?$impressions:0; ?>
			</td>
			<td class="center con0"><?php echo ($clicks!='')?$clicks:0; ?></td>
			<td class="center con1"><?php echo ($conversions!='')?$conversions:0; ?>
			</td>
			<td class="con0" style=""><?php echo $ctr; ?></td>
			<?php if($camp->revenue_type==1): ?>
			<td class="con1" style=""><?php echo number_format((($camp->revenue)/1000),2); ?>
			</td>
			<?php else: ?>
			<td class="con1" style=""><?php echo number_format($camp->revenue,2); ?>
			</td>
			<?php endif; ?>
			<td class="con0" style=""><?php echo number_format($dailyBalance,2); ?>
			</td>
			<td class="con1" style=""><?php echo number_format($campAmt,2); ?></td>
		</tr>
		<?php endforeach;
                endif; ?>
	</tbody>
