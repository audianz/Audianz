...
<table cellpadding="0" cellspacing="0" border="0" class="dyntable" id="adv_stat">
    <thead>
        <tr>
            ...
            <th class="head0"><?php echo $this->lang->line('lang_statistics_advertiser_store_name');?></th>
            <th class="head1"><?php echo $this->lang->line('lang_statistics_advertiser_store_city');?></th>
			...
			<th class="head0"><?php echo $this->lang->line('lang_statistics_advertiser_landing_page');?>(<?php echo $stat_data['tot_val']['LAND']; ?>)</th>
			<th class="head1"><?php echo $this->lang->line('lang_statistics_advertiser_call');?> (<?php echo $stat_data['tot_val']['CALL']; ?>)</th>
		    <th class="head0"><?php echo $this->lang->line('lang_statistics_advertiser_web');?> (<?php echo $stat_data['tot_val']['WEB']; ?>)</th>
