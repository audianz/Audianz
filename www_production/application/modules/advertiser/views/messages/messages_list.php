	...
	jQuery('#camptab').dataTable( {
	 ...
	 <?php if($page_title != ''): ?><h1 class="pageTitle"><?php echo $page_title; ?></h1><?php endif; ?> 
	   <div style="width:44%;float:right;text-align: right;">
         <a href="<?php echo site_url('advertiser/messages'); ?>" class="iconlink"><span>Inbox</span></a>
       
	     <a href="<?php echo site_url('advertiser/messages/sent_list'); ?>" class="iconlink"><span>Outbox</span></a>
       
	     <a href="<?php echo site_url('advertiser/messages/add'); ?>" class="iconlink views"><span><?php echo 'Compose';//$this->lang->line("label_suggestions_add_new"); ?></span></a>
       </div>
	   <br /><br />
            ...
            <tbody>
  			...
  			<?php 
				...
				<tr>
					...
					<td align="center"><a href="<?php echo site_url('advertiser/messages/view/'.$row->suggestion_id); ?>" class="view">
					...
					<?php $chk =$this->mod_suggestions->get_reply_status($row->suggestion_id); if($chk ==0) : ?>
					 <a href="<?php echo site_url('advertiser/messages/reply/'.$row->suggestion_id); ?>" class="views"><?php echo $this->lang->line("label_suggestions_reply_reply"); ?></a>
					 <?php endif; ?>
					 </td>
				</tr>	 
  			  <?php	endforeach; ?>
