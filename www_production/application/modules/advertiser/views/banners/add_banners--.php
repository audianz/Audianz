	...
	<fieldset>
		...
		<span id="sec1">
			...
			<hr/>
			 ...
			 <p>
				<label for="name"><?php echo 'Large ('.$mob_screens[0]['width'].'X'.$mob_screens[0]['height'].')';//$this->lang->line('label_large'); ?> <span style="color:red;" >*</span></label>
				<input class="validate[required] sf" type="file" name="large_banner" alt="<?php echo $this->lang->line('label_alert_large_banner'); ?>" value="<?php echo form_text(set_value('large_banner')); ?>"/>
			</p>
			 <p>
				<label for="name"><?php echo 'Medium ('.$mob_screens[1]['width'].'X'.$mob_screens[1]['height'].')';//$this->lang->line('label_medium'); ?> <span style="color:red;" >*</span></label>
				<input class="validate[required] sf" type="file" name="medium_banner" alt="<?php echo $this->lang->line('label_alert_medium_banner'); ?>" value="<?php echo form_text(set_value('medium_banner')); ?>"/>
			</p>
			 <p>
				<label for="name"><?php echo 'Small ('.$mob_screens[2]['width'].'X'.$mob_screens[2]['height'].')';//$this->lang->line('label_small'); ?> <span style="color:red;" >*</span></label>
				<input class="validate[required] sf" type="file" name="small_banner" alt="<?php echo $this->lang->line('label_alert_small_banner'); ?>" value="<?php echo form_text(set_value('small_banner')); ?>"/>
			</p>
			 <p>
				<label for="name"><?php echo 'X-Small ('.$mob_screens[3]['width'].'X'.$mob_screens[3]['height'].')';//$this->lang->line('label_x_small'); ?> <span style="color:red;" >*</span></label>
				<input class="validate[required] sf" type="file" name="x_small_banner" alt="<?php echo $this->lang->line('label_alert_x_small_banner'); ?>" value="<?php echo form_text(set_value('x_small_banner')); ?>"/>
			</p>
			 <p>
