	...
	<div style="float:right;background-color:grey;margin-top:0%;margin-right:4%;width:50%;height:350px" >
		<div style="height:67%;background-color:green;">
			<div style="width:60%;height:100%;background-color:blue;float:left;" id="add-image1" >
				<img src="<?php echo base_url(); ?><?php echo $pages[1]->image1; ?>" width="100%" height="100%" style="border:3px solid white;" />
			</div>
			<div style="width:40%;height:100%;background-color:pink;float:right;">
				<div style="height:50%;background-color:grey;" id="add-image2" >
				<img src="<?php echo base_url(); ?><?php echo $pages[1]->image2; ?>" width="100%" height="100%" style="border:3px solid white;" /></div>
				<div style="height:50%;background-color:red;border:3px solid white;" id="add-image3" >
				<img src="<?php echo base_url(); ?><?php echo $pages[1]->image3; ?>" width="100%" height="100%" style="border:3px solid white;" /></div>
			</div>
		</div>
		...
		<div style="height:33%;;background-color:yellow;">
			...
			<img src="<?php echo base_url(); ?><?php echo $pages[1]->image4; ?>" width="100%" height="100%" style="border:3px solid white;" /></div>
			<div style="width:60%;height:100%;background-color:green;float:right" id="add-image5">
			<img src="<?php echo base_url(); ?><?php echo $pages[1]->image5; ?>" width="100%" height="100%" id="image5" style="border:3px solid white;" /></div>
		</div>
