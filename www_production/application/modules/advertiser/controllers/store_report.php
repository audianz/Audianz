...
class Store_report extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['stat_data'] = $this->mod_statistics->get_store_report_for_advertiser_datewise($search_arr);
		
		/*------------------------------------------------------------
		 Embed current page content into template layout
		-------------------------------------------------------------*/

		$data['page_content']		=		 $this->load->view("report/store_wise_list",$data,true);
	...
	public function export_stores_excel()
	{
		...
		$data['date_range']	=	$search_arr;
		$data['stat_data'] = $this->mod_statistics->get_store_report_for_advertiser_datewise($search_arr);
			
		$this->mod_statistics->export_storefront_excel($data);
	}
}
