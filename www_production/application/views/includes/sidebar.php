        ...
        <div class="content" style="display: block;">
        	<ul class="leftmenu">
				...
				<?php if($this->uri->segment(2)=='myaccount'){ ?>
					<li class="current"><a href="<?php echo site_url('admin/myaccount'); ?>" class="editor"><?php echo $this->lang->line('label_account_settings'); ?></a></li>
				<?php } else { ?>
					<li><a href="<?php echo site_url('admin/myaccount'); ?>" class="editor"><?php echo $this->lang->line('label_account_settings'); ?></a></li>
				<?php } ?>
				<?php if($this->uri->segment(3)=='change_password'){ ?>
					<li class="current"><a href="<?php echo site_url('admin/site_settings/change_password'); ?>" class="buttons"><?php echo $this->lang->line('label_change_password'); ?></a></li>
				<?php } else { ?>
					<li><a href="<?php echo site_url('admin/site_settings/change_password'); ?>" class="buttons"><?php echo $this->lang->line('label_change_password'); ?></a></li>
				<?php } if($this->uri->segment(2)=='messages'){ ?>
					<li class="current"><a href="<?php echo site_url('admin/messages/messages_list'); ?>" class="editor"><?php echo $this->lang->line('label_messages'); ?></a></li>
				<?php } else { ?>
					<li><a href="<?php echo site_url('admin/messages/messages_list'); ?>" class="editor"><?php echo $this->lang->line('label_messages'); ?></a></li>
				<?php } ?>
				...
				{
				?>
						<li <?php echo($this->uri->segment(2)=="inventory_advertisers")?"class='current'":""; ?> ><a href="<?php echo site_url("admin/inventory_advertisers"); ?>" class="form"><?php echo $this->lang->line('label_advertisers'); ?></a></li>
						<li <?php echo($this->uri->segment(2)=="inventory_campaigns")?"class='current'":""; ?>><a href="<?php echo site_url("admin/inventory_campaigns");; ?>" class="gallery"><?php echo $this->lang->line('label_campaigns'); ?></a></li>
						...
						<li <?php echo($this->uri->segment(2)=="inventory_websites")?"class='current'":""; ?>><a href="<?php echo site_url("admin/inventory_websites"); ?>" class="table"><?php echo $this->lang->line('label_websites'); ?></a></li>
						<li <?php echo($this->uri->segment(2)=="inventory_zones")?"class='current'":""; ?>><a href="<?php echo site_url("admin/inventory_zones"); ?>" class="calendar"><?php echo $this->lang->line('label_zones'); ?></a></li>
<li <?php echo($this->uri->segment(2)=="inventory_zones_sdk")?"class='current'":""; ?>><a href="<?php echo site_url("admin/inventory_zones_sdk"); ?>" class="calendar"><?php echo $this->lang->line('label_zones_mobile'); ?></a></li>
				<?php
				}
				else if($a[0]=="pages")
				{
				...
				else if($a[0]=="statistics" || $this->uri->segment(2)=="payment_history" || $this->uri->segment(2)=="smaato_delivery_report")
				{
				?>
						<li <?php echo($this->uri->segment(2)=="statistics_advertiser")?"class='current'":""; ?> ><a href="<?php echo site_url('admin/statistics_advertiser'); ?>" class="form">
						<?php echo $this->lang->line('lang_statistics_advertiser_page_title'); ?></a></li>
						<li <?php echo($this->uri->segment(2)=="statistics_publisher")?"class='current'":""; ?>><a href="<?php echo site_url('admin/statistics_publisher'); ?>" class="gallery">
						...
						<li <?php echo(($this->uri->segment(2)=="statistics_global" AND $this->uri->segment(3)=="country_wise_statistics"))?"class='current'":""; ?>><a href="<?php echo site_url('admin/statistics_global/country_wise_statistics'); ?>" class="table">
						<?php echo $this->lang->line('label_country'); ?></a></li>
						
						<li <?php echo(($this->uri->segment(2)=="payment_history"))?"class='current'":""; ?>><a href="<?php echo site_url('admin/payment_history'); ?>" class="table">
						<?php echo $this->lang->line('label_payment_history_data'); ?></a></li>
						<li <?php echo(($this->uri->segment(2)=="smaato_delivery_report"))?"class='current'":""; ?>><a href="<?php echo site_url('admin/smaato_delivery_report'); ?>" class="table">
						<?php echo "Smaato"; ?></a></li>
				...
				else if($a[0]=="settings" || $this->uri->segment(2)=="smaato_share_settings" || $this->uri->segment(2)=="camp_optimisation" )
				{
				?>
						...
						<li <?php echo($this->uri->segment(2)=="settings_network_carriers")?"class='current'":""; ?>>

						<a href="<?php echo site_url("admin/settings_network_carriers"); ?>" class="form">

						<?php echo "Network Carrier Details"; ?></a></li>
						...
						<li <?php echo($this->uri->segment(2)=="smaato_share_settings")?"class='current'":""; ?>>

						<a href="<?php echo site_url("admin/smaato_share_settings"); ?>" class="form">

						<?php echo "Smaato share";?>

						</a></li>

		
						<li <?php echo($this->uri->segment(2)=="camp_optimisation")?"class='current'":""; ?>>

						<a href="<?php echo site_url("admin/camp_optimisation"); ?>" class="form">

						<?php echo "Manage Optimization Mix ";?>
		 ...
		 <?php }else if($this->uri->segment(2) ==="approvals")  //Approval Settings sidebar
				...
				?>
					<li <?php echo($this->uri->segment(3)=="advertisers")?"class='current'":""; ?>>
						...
						<a href="<?php echo site_url("admin/approvals/advertisers"); ?>" class="table">
						...
						<a href="<?php echo site_url("admin/approvals/publishers"); ?>" class="table">
						...
						<a href="<?php echo site_url("admin/approvals/banners"); ?>" class="buttons">
