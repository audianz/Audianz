...
<title><?php echo $site_data->site_title.' | '.$this->lang->line('site_caption'); ?></title>
...
<div class="headerspace_site">
	<div class="headerspace_content"><a href="<?php echo site_url('site/registration');?>">Sign up</a> | <a href="<?php echo site_url('site');?>">Log in</a></div>	
</div>
...
//$title_name= 'mining120x20.gif';			
		if(	$image_name != '')
		{?>
		<a href="<?php echo site_url($this->uri->segment(1)); ?>"><img src="<?php echo base_url().$this->config->item('admin_site_logo_view').$image_name;?>" alt="<?php echo $image_name;?>"></a><br />	
		<?php }  elseif($title!= '' ){ ?>
    <!-- logo -->
	<div style="height:54px"><a href="<?php echo site_url($this->uri->segment(1)); ?>"><font color="#FFFFFF" size="6" ><?php echo $title;?></font></a></div>
    	
		<?php } else { ?>
    <!-- logo -->
	<a href="<?php echo site_url($this->uri->segment(1)); ?>"><img src="<?php echo base_url();?>assets/images/logo2.png" alt="Logo" /></a>
    <?php }?>
