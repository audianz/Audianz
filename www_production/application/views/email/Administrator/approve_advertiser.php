        ...
        <table width="100%" height="300" border="0" align="center" cellpadding="0" cellspacing="0" >
          <tr>
			...
			<p style="padding-top:15px;"><strong><?php echo $this->lang->line('registration_dear');?> <?php echo  $username; ?>,</strong></p>
              <p style="padding-top:10px;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $this->lang->line('lang_account_advertiser_activated'); ?></p><br>
              <br>
			    <table width="280" height="96" border="0" style="padding-top:15px;">
                <tr>
                ...
                <tr>
				 ...
				 <tr>
                  <td colspan="2"><b><a href="<?php echo site_url("site"); ?>"><?php echo $this->lang->line('label_site_name'); ?></a></td>
                  </tr>
                <tr>
