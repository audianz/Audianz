        ...
        <table width="100%" height="300" border="0" align="center" cellpadding="0" cellspacing="0" >
          <tr>
			...
			<p style="padding-top:15px;"><strong><?php echo $this->lang->line('registration_dear');?> <?php echo  $username; ?>,</strong></p>
              <p style="padding-top:10px;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $this->lang->line('lang_forget_password_msg'); ?></p>
			    <table width="292" border="0" style="padding-top:15px;">
                <tr>
                  <td colspan="2" align="center"><b><?php echo $this->lang->line('lang_email_acc_det'); ?></b></td>
                  </tr>
                <tr>
                  <td style="white-space:nowrap"><b><?php echo $this->lang->line('lang_email_username'); ?></b></td>
                  <td style="white-space:nowrap">:&nbsp;<?php echo  $username; ?></td>
                </tr>
                <tr>
                  <td style="white-space:nowrap"><b><?php echo $this->lang->line('lang_forget_password_password'); ?></b></td>
