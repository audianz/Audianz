        ...
        <table width="100%" height="300" border="0" align="center" cellpadding="0" cellspacing="0" >
          <tr>
			...
			<p style="padding-top:15px;"><strong><?php echo $this->lang->line('registration_dear');?> <?php echo  $client_name; ?>,</strong></p>
              <p style="padding-top:10px;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $this->lang->line('label_account_banner_activated'); ?></p>
			   <table width="256" border="0" style="padding-top:15px;">
                <tr>
                  <td colspan="2"><b><?php echo $this->lang->line('label_account_banner_details'); ?></b></td>
                 </tr>
                <tr>
