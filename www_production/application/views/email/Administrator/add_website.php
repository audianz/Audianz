        ...
        <table width="100%" height="300" border="0" align="center" cellpadding="0" cellspacing="0" >
          <tr>
			...
			<p style="padding-top:15px;"><strong><?php echo $this->lang->line('registration_dear');?> <?php echo  $username; ?>,</strong></p>
              <p style="padding-top:10px;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $this->lang->line('lang_add_website_msg1'); ?><?php echo $this->lang->line('site_title'); ?><?php echo $this->lang->line('lang_add_website_msg2'); ?><?php echo $this->lang->line('site_title'); ?><?php echo $this->lang->line('lang_add_website_msg3'); ?></p>
                  <table width="274" border="0" style="padding-top:15px;">
                <tr>
				...
				<tr>
                  <td><?php echo $this->lang->line('lang_add_website_name'); ?></td>
                  <td style="white-space:nowrap">:&nbsp;<?php echo $websitename; ?></td>
                </tr>
