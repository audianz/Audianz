        ...
        <table width="100%" height="300" border="0" align="center" cellpadding="0" cellspacing="0" >
          <tr>
			...
			<p style="padding-top:15px;"><strong><?php echo $this->lang->line('registration_dear');?> <?php echo  $name; ?>,</strong></p>
              ...
              <?php  echo "Your account has been updated by administrator. Find the details below," ; ?>
              </p>
                  <table width="239" border="0" style="padding-top:15px;">
                <tr>
                  <td colspan="2" ><b><?php echo $this->lang->line('lang_email_acc_det');
                  ?></b></td>
                  </tr>
                <tr>
                  <td style="white-space:nowrap">Address : </td>
                  <td style="white-space:nowrap">:&nbsp;<?php echo  $address; ?></td>
                </tr>
                <tr>
                  <td style="white-space:nowrap">City : </td>
                  <td style="white-space:nowrap">:&nbsp;<?php echo  $city; ?></td>
                </tr>
                <tr>
                  <td style="white-space:nowrap">State :</td>
                  <td style="white-space:nowrap">:&nbsp;<?php echo  $state; ?></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td style="white-space:nowrap">:&nbsp;<?php echo  $mobile; ?></td>
                </tr>
                <tr>
                  <td style="white-space:nowrap">Zip code :</td>
                  <td style="white-space:nowrap">:&nbsp;<?php echo  $zip_code; ?></td>
                </tr>
