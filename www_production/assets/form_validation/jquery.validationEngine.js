			...
			switch (field.prop("type")) {
				...
				default:
					...
					if (! $.trim(field.val()) || field.val() == field.attr("data-validation-placeholder"))
						return field.attr("alt");//options.allrules[rules[i]].alertText;
					break;
				case "radio":
				case "checkbox":
					var form = field.closest("form");
					...
					if (form.find("input[name='" + name + "']:checked").size() == 0) {
						if (form.find("input[name='" + name + "']").size() == 1)
							return field.attr("alt");//options.allrules[rules[i]].alertTextCheckboxe;
						else
							return field.attr("alt");//options.allrules[rules[i]].alertTextCheckboxMultiple;
					}
					break;
				// required for <select>
				case "select-one":
