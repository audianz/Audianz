 ...
 */(function(i,za,p) {
    ...
    i.fn.dataTable = function(g) {
        ...
        function v(a,b) {
            var c;
            c = i.isArray(b)?b.slice():i.extend(true, {}
            ,b);
            b = a.aoData.length;
            var d =  {
                nTr:null
        ...
        function $(a) {
            var b,c,d,f,e,h,j,k
            ,m;if(a.bDeferLoading || a.sAjaxSource === null) {
...
d;c++)a.aoServerParams[c].fn.call(a.oInstance,b)
        ...
        function Ma(a) {
            ...
            , d=a.nTable.parentNode,f,e,h,j,k,m,u,r
            ,H=[]
...
h;c<a;c++)d[h * c + b].className = i.trim(d[h * c + b].className.replace(" " + e + "3",""))
        ...
        function Ga(a) {
            if(a.oScroll.bInfinite)return null;
            var b = '<select size="1" ' + (a.sTableId === ""?"":'name="' + a.sTableId + '_length"') + ">",c
            ,d;if(a.aLengthMenu.length == 2 && typeof a.aLengthMenu[0] == "object" && typeof a.aLengthMenu[1] == "object") {
                c = 0;
...
a.aoColumns.length;d++) {
        ...
        function Xa(a,b) {
            if(a.oFeatures.bStateSave) {
                var c,d
                ,f;d = wa(a.sCookiePrefix + a.sInstance);
                if(d !== null && d !== "") {
                    try {
...
j;d++)a.push([]);
        ...
        this.fnClose = function(a) {
            for(var b = A(this[n.iApiIndex])
            ,c=0;
            c < b.aoOpenRows.length;
            c++)if(b.aoOpenRows[c].nParent == a) {
        ...
        this.fnSetColumnVis = function(a,b,c) {
            var d = A(this[n.iApiIndex]),f
            ,e;e = d.aoColumns.length;
            var h
            ,j;if(d.aoColumns[a].bVisible != b) {
                if(b) {
