...
$tinybrowser['path']['image'] = '/uploadedfiles/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/uploadedfiles/media/'; // Media files location
$tinybrowser['path']['file']  = '/uploadedfiles/files/'; // Other files location
...
$tinybrowser['link']['image'] = "http://www.clapfilmes.pt/".$tinybrowser['path']['image']; // Image links
$tinybrowser['link']['media'] = "http://www.clapfilmes.pt/".$tinybrowser['path']['media']; // Media links
$tinybrowser['link']['file']  = "http://www.clapfilmes.pt/".$tinybrowser['path']['file']; // Other file links
