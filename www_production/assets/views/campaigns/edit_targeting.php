...
<p>
    ...
    <table width="40%">
            <tr>
                    ...
                    <td align="center">
                            <select name="destination_ope[]" id="destination_ope" multiple="multiple"class="validate[required] " alt="<?php echo $this->lang->line('label_select_specific_geo_operator');?>" c  size="<?php echo (count($geooperator)>=20)?'20':count($geooperator); ?>">
