     ...
     <form id="frmTrackerList" action="<?php //echo site_url('admin/inventory_advertisers/tracker_process/rem/'.$sel_advertiser_id); ?>" method="post" >
        <?php if(count($trackers_list) > 0 AND $trackers_list != FALSE ): ?>
        ...
        <div  class="sTableWrapper">
            <table cellpadding="0" cellspacing="0" class="sTable" id="userlist" width="100%">
				...
				?>
				<tr>
		                    <td align="center" colspan="6"><strong><?php echo $this->lang->line("label_advertiser_trackers_record_not_found"); ?></strong></td>
                		</tr>
				<?php endif; ?>
		 </table>
		   </div><!--sTableWrapper-->
