...
<div class="notification msginfo"> <a class="close"></a> <p><?php echo $this->session->flashdata('pause_banner'); ?></p></div>
<?php
endif;

if($this->session->flashdata('run_banner') != ""): ?>
<div class="notification msginfo"> <a class="close"></a> <p><?php echo $this->session->flashdata('run_banner'); ?></p></div>
<?php
endif;

if($this->session->flashdata('banner_account_error') != ""): ?>
<div class="notification msginfo"> <a class="close"></a> <p><?php echo $this->session->flashdata('banner_account_error'); ?></p></div>
<?php
endif;
			...
			<a title="<?php echo $this->lang->line('label_banner_edit_banner_details'); ?>" href="<?php echo site_url('advertiser/banners/edit_banner/'.$row->campaignid.'/'.$row->bannerid); ?>">
				<?php echo view_text($row->description); ?>
                   ...
                   <td class="con0"><?php echo view_text($row->url); ?></td>
                    <td class="con1" align="center"><?php echo $size; ?></td>
                    <td class="center con0"><?php echo (isset($stat_list[$row->bannerid]))?$stat_list[$row->bannerid]['IMP']:"0"; ?></td>
                    <td class="center con1"><?php echo (isset($stat_list[$row->bannerid]))?$stat_list[$row->bannerid]['CLK']:"0"; ?></td>
					<td class="center con0"><?php echo (isset($stat_list[$row->bannerid]))?$stat_list[$row->bannerid]['CON']:"0"; ?></td>
                    <td class="center con1"><?php echo (isset($stat_list[$row->bannerid]))?number_format($stat_list[$row->bannerid]['CTR'],2,".",","):"0.00"; ?>%</td>
                    <td class="center con0">$<?php echo (isset($stat_list[$row->bannerid]))?number_format($stat_list[$row->bannerid]['SPEND'],2):"0.00"; ?></td>
			<?php if($row->adminstatus == 0)
			{ 
			?>
                    <td class="center con1"><a href="<?php echo site_url("advertiser/banners/linked_zones/".$row->bannerid."/".$campaignid); ?>"><?php echo $this->lang->line('label_advertiser_banners_zones'); ?></a></td>
			<?php
			}
			else
			{
			?>
		   <td class="center con1"><a onClick="auth_display()" href="javascript:void(0);"><?php echo $this->lang->line('label_advertiser_banners_zones'); ?></a></td>
			<?php
			}
			?>
                    ...
                    <?php if($row->adminstatus==0): ?>
                        <td class="con0" align="center"><?php echo $this->lang->line('label_active'); ?></td>
                    <?php else: ?>
                        <td class="con1" align="center"><?php echo $this->lang->line('label_inactive'); ?></td>
                    <?php endif; ?>
