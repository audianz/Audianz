		...
		<span id="sec1">
			...
			<hr/>
			 <p>
				...
				<input class="validate[required] sf" type="text" name="img_banner_name" alt="<?php echo $this->lang->line('label_alert_banner_name'); ?>" value="<?php echo form_text(set_value('img_banner_name')); ?>"/>
			</p>	
			 <p>
