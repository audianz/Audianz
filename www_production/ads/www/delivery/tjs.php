...
$budget_val=mysql_fetch_array($budget_value);
			...
			//echo "update oxm_report set amount='$total',publisher_amount='$publisher_commission' where clientid='$client_id' AND zoneid='$zid' AND bannerid='$cid'AND pricingmodel='$revenue_type' AND date='$date'";exit;
