...
function MAX_redirect($url)
{
	//added by neha
	global $log;
	$log->logDebug("MAX_redirect url is ".$url);
/*	global $bannerurl;
	$bannerurl = $url;
	$keyVal = "bannerid";
...
<script>
	...
	<!--
	<h2>
	<a href="#" onclick="check()" >Click here to call.</a> 
...
{
global $log;
$log->logDebug("entered log_store_click() arr is ".print_r($arr,true));
...
$log->logDebug("destination ad id  is".$adId[0]);
