...
function mobileParameters($type)
{
			...
			if($type == 'handset') {
				...
				return $hanset_model;
					...
					if($all[6]['value']=="false"){$hanset_capability[] = $all[6]['value'];}else{$hanset_capability[]="j2me_midp_1_0";}
					if($all[7]['value']=="false"){$hanset_capability[]= $all[7]['value'];}else{$hanset_capability[]="j2me_midp_2_0";}
					if($all[8]['value']=="false"){$hanset_capability[] = $all[8]['value'];}else{$hanset_capability[]="fl_browser";}
					if($all[9]['value']=="false")
						{$hanset_capability[] = $all[9]['value'];}
					else
						{$hanset_capability[]="progressive_download";}  //device capability
