 ...
 */
 ...
 //======================= openxmods ================================//
 function Model_limitationsMatchStringValue($value, $limitation, $op)
{
...
function MAX_limitationsMatchArrayValue1(&$value, &$limitation, $op)
{

 	$con=explode(",",$limitation);

 	if(array_intersect($value,$con))
	{
