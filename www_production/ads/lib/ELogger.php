...
class ELogger
{
    ...
    const INFO = 6; //6 Informational: informational messages
    const DEBUG = 7; //7 Debug: debug messages
...
*/
    const NO_ARGUMENTS = 'ELogger::NO_ARGUMENTS';
...
*/
    ...
    /**
* Array of ELogger instances, part of Singleton pattern
* @var array
*/
...
*/
	 ...
	 $this->_logFilePath = $logDirectory
        ...
        {
        	$newname	= $logDirectory.DIRECTORY_SEPARATOR.'log_backup'.'.txt';
        	rename($this->_logFilePath,$newname);
        }
...
*/
    ...
    /**
* Sets the date format used by all instances of ELogger
*
